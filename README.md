...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mudata-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15289&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mudata-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mudata` can be installed with:

```
conda install mudata
```

It is possible to list all of the versions of `mudata` available on your platform with:
